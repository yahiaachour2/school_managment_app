...
function Navbar() {
  ...
  return (
    <nav className="bg-gray-50 border-gray-200 dark:bg-gray-900 z-30">
      <div className="w-full flex flex-wrap items-center justify-between mx-auto px-2 p-4">
        <a href="http://localhost:5173/users/student" className="flex items-center space-x-3 rtl:space-x-reverse">
          <span className="self-center text-4xl whitespace-nowrap text-blue-500 font-bold dark:text-white">Smart School</span>
        </a>
